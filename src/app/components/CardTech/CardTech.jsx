...
const CardTech = ({imgId,Name,Description}) => {
  return (
    <>
        <main className='min-w-0.5 flex flex-col  md:flex-row items-center justify-between  py-20 px-20 bg-white max-w-2xl border-transparent shadow-2xl rounded-2xl ' >
           
                        <Image src={`/${imgId}.png`} width={100} height={50} alt='imgLogo'/>
            <div>
